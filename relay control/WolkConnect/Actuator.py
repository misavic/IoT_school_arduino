...
class ActuatorType(ReadingType):
    ...
    RELAY_SWITCH = ("RAC", DataType.BOOLEAN, ActuatorState.READY)
...
class ColorSwitch(Actuator):
    """ Switch actuator
    """
    def __init__(self, value):
        super().__init__(ActuatorType.COLOR_SWITCH, value)
...
class ColorSlider(Actuator):
    """ Slider actuator
    """
    def __init__(self, value):
        super().__init__(ActuatorType.COLOR_SLIDER, value)
...
class RelaySwitch(Actuator):
    """ Switch actuator
    """
    def __init__(self, value):
        super().__init__(ActuatorType.RELAY_SWITCH, value)
